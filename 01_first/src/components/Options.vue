<template>
    <div>
        ...
        <p>
            <!-- 계산된 속성을 여러 번 사용하더라도 sqrt()를 여러번 호출하는 것이 아니다. -->
            <!-- sqrt()의 실행 결과를 가지고 있는  -->
...
<script>
    export default {
        ...
        watch: {
            ...
            // 매개값으로는 'newValue'는 변경된 값, 'oldValue'는 이전 값을 전달받는다.
            // x(newValue, oldValue) {
            ...
            values: {
                ...
                // 겍체 내부의 값이 변경될 때 handler 함수가 실행되도록 지정하는 함수이다,
                deep:true
